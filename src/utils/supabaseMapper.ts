...
export const mapPenerimaFromSupabase = (row: any): PenerimaAlokasi => ({
  ...
  brutoJaspel: Number(row.bruto_jaspel ?? row.total_diterima ?? row.brutoJaspel ?? 0),
  ...
  nettoDiterima: Number(row.netto_diterima ?? row.total_diterima ?? row.nettoDiterima ?? 0),
  ...
  nominalBebanTetap: Number(row.nominal_beban_tetap ?? row.nominalBebanTetap ?? 0),
  nominalPostRemunerasi: Number(row.nominal_post_remunerasi ?? row.nominalPostRemunerasi ?? 0),
  nominalAdministrasi: Number(row.nominal_administrasi ?? row.nominalAdministrasi ?? 0),
  nominalJasaLangsung: Number(row.nominal_jasa_langsung ?? row.nominalJasaLangsung ?? 0),
  potonganCuti: Number(row.potongan_cuti ?? row.potonganCuti ?? 0),
  nominalKoreksi: Number(row.nominal_koreksi ?? row.nominalKoreksi ?? 0),
});

export const mapPenerimaToSupabase = (item: PenerimaAlokasi) => ({
  id: item.id,
  alokasi_id: item.alokasiId || '',
  pegawai_id: item.pegawaiId || '',
  nama: item.nama,
  unit_kerja: item.unitKerja || '',
  jabatan: item.jabatan || '',
  kategori: item.kategori,
  poin_dasar: item.poinDasar,
  poin_kompetensi: item.poinKompetensi,
  poin_risiko: item.poinRisiko,
  poin_kinerja: item.poinKinerja,
  total_poin: item.totalPoin,
  nilai_per_poin: item.nilaiPerPoin,
  bruto_jaspel: item.brutoJaspel,
  pajak_pph21_persen: item.pajakPph21Persen,
  potongan_pph21: item.potonganPph21,
  netto_diterima: item.nettoDiterima,
  status_koreksi: item.statusKoreksi,
  catatan_koreksi: item.catatanKoreksi || '',
  sudah_dibayar: item.sudahDibayar,

  nominal_beban_tetap: item.nominalBebanTetap || 0,
  nominal_post_remunerasi: item.nominalPostRemunerasi || 0,
  nominal_administrasi: item.nominalAdministrasi || 0,
  nominal_jasa_langsung: item.nominalJasaLangsung || 0,
  potongan_cuti: item.potonganCuti || 0,
  nominal_koreksi: item.nominalKoreksi || 0,
  total_diterima: item.nettoDiterima || item.brutoJaspel || 0,
