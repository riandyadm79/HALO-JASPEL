...
export const getInitialSupabaseConfig = (): SupabaseConfig => {
  ...
  return {
    supabaseUrl: env.SUPABASE_URL || 'https://xvyz-halojapel-project.supabase.co',
    supabaseAnonKey: env.SUPABASE_ANON_KEY || 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZS1oYWxvLWphcGVsIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDAzODQwMDB9.mock-anon-key-signature',
    serviceRoleKey: '',
